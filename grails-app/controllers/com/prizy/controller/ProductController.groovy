...
import com.prizy.strategy.PricingStategy
...
class ProductController {
	...
	def loadPrice() {
		List<Product> productInstanceList = Product.list(sort: "barcode",  order: "asc") 
	...
	def savePrices() {
		...
		if(tempPriceList.isEmpty()) {
			...
			flash.message = message(code: 'default.add.prices.message', args: [
				message(code: 'product.label', default: 'Product'), productInstance])
			addPrices(productInstance)
		} else {
			println "else:::::::::::::::"+tempPriceList
