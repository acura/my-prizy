...
import com.prizy.controller.PriceController
import com.prizy.domain.Price
import com.prizy.domain.Product
import com.prizy.service.PriceService
...
class PriceControllerSpec extends Specification {
    ...
    void "Test the index action returns the correct model"() {
		given:
			...
			Price price
			for(int i=11;i<=20;i++) {
				price = new Price(price: i, product: testProduct, storeName: "Store 1", notes: "this is for testing purpose")
				price.save()
			}
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        when:"The save action is executed with a valid instance"
            response.reset()
            testPrice = new Price(price: new BigDecimal("999"), product: testProduct, storeName: "Store 1", notes: "this is for testing purpose")
    ...
    void "Test the update action performs an update on a valid domain instance"() {
        ...
        when:"A valid domain instance is passed to the update action"
            ...
            testPrice = new Price(price:new BigDecimal("123"), product: testProduct, storeName: "Store 1", notes: "this is for testing purpose")
    ...
    void "Test that the delete action deletes an instance if it exists"() {
        ...
        when:"A domain instance is created"
            ...
            testPrice = new Price(price:123,product: testProduct, storeName: "Store 1", notes: "this is for testing purpose")
			testPrice.save(flush: true)
